...
import { type SingleSearchResult } from "~/store";
type Props = {
...
export default function SingleCatalogRow({ cardData }: Props) {
  ...
  return (
    <>
      <>
        <div className="my-2 grid grid-cols-12 gap-4 rounded-md bg-zinc-900 p-2 transition-all hover:bg-zinc-700 sm:my-3 sm:p-4">
